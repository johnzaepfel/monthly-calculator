        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl">
                    ...
                    <form action="{{ route('purchases.update',$purchase->id) }}" method="POST" enctype="multipart/form-data" class="mt-6 space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input type="text" name="description" value="{{ $purchase->description }}" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" placeholder="Description">
                            @error('description')
                            <div class="text-rose-600 dark:text-rose-500 text-sm">{{ $message }}</div>
                            @enderror
                        </div>
